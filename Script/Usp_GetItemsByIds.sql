...
/****** Object:  StoredProcedure [dbo].[Usp_GetItemsByIds]    Script Date: 8/20/2025 1:41:46 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE    procedure [dbo].[Usp_GetItemsByIds]
		(  @FilterItemID   [dbo].[GuidType]  READONLY    )
...
begin 
	...
	WHERE I.ItemID IN ( SELECT ID FROM @FilterItemID  )
