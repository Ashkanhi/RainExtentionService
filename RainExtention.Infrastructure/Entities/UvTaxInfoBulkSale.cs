...
[Keyless]
public partial class UvTaxInfoBulkSale
{
    ...
    [Column("cap", TypeName = "decimal(38, 6)")]
    ...
    [Column("tdis", TypeName = "decimal(38, 9)")]
    public decimal? Tdis { get; set; }

    [Column("tadis", TypeName = "decimal(38, 6)")]
    public decimal? Tadis { get; set; }

    [Column("tvam", TypeName = "decimal(38, 9)")]
    public decimal? Tvam { get; set; }

    [Column("todam")]
    public int? Todam { get; set; }

    [Column("tbill", TypeName = "decimal(38, 6)")]
    ...
    [Column("irtaxid")]
    [StringLength(1)]
    public string Irtaxid { get; set; } = null!;
    ...
    [Column("dis", TypeName = "decimal(38, 9)")]
    public decimal? Dis { get; set; }

    [Column("adis", TypeName = "decimal(38, 6)")]
    public decimal? Adis { get; set; }

    [Column("vra", TypeName = "decimal(19, 3)")]
    public decimal? Vra { get; set; }

    [Column("vam", TypeName = "decimal(38, 9)")]
    ...
    [StringLength(1)]
    [Unicode(false)]
    public string Olt { get; set; } = null!;
    ...
    [Column("tsstam", TypeName = "decimal(38, 6)")]
